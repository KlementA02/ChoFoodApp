...
class CatWidgetTxt extends StatelessWidget {
  const CatWidgetTxt({
    super.key,
  });
            ...
            children: [
              Container(
                ...
                child: Container(
                  width: 65,
                  height: 65,
                  padding: const EdgeInsets.fromLTRB(19.9, 18.9, 18.9, 19.9),
                  child: SizedBox(
                    width: 26.3,
                    height: 26.3,
                    child: SizedBox(
              ...
              Container(
                ...
                child: Container(
                  width: 65,
                  height: 65,
                  padding: const EdgeInsets.fromLTRB(1, 20.8, 0, 20.5),
                  child: SizedBox(
                    width: 22.5,
                    height: 23.8,
                    child: SizedBox(
              ...
              Container(
                ...
                child: Container(
                  width: 65,
                  height: 65,
                  padding: const EdgeInsets.fromLTRB(19.5, 19.5, 19.5, 20.5),
                  child: SizedBox(
                    width: 25,
                    height: 25,
                    child: SizedBox(
...
class NStoreWidget extends StatelessWidget {
  const NStoreWidget({
    super.key,
    this.showDiscount = false,
    this.name = "Auntie Betty",
    this.discountText = "10",
    this.rating = "4.6",
    this.timeText = "10 ",
    this.imageName = "rectangle_91.jpeg",
  });

  final bool showDiscount;
  final String name, discountText, rating, timeText, imageName;
          ...
          child: showDiscount
              ? Stack(
                  children: [
                    const DiscountTag(),
                    Container(
                      padding: const EdgeInsets.fromLTRB(11, 75, 11, 4),
                      child: Text(
                        '$discountText OFF',
                        style: GoogleFonts.getFont(
                          'Poppins',
